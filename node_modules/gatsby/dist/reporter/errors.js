...
function createErrorFromString(errorStr) {
  var _errorStr$split = errorStr.split(/\r\n|[\n\r]/g),
      _errorStr$split2 = (0, _toArray3.default)(_errorStr$split),
      message = _errorStr$split2[0],
      rest = _errorStr$split2.slice(1);
...
module.exports = {
  createErrorFromString: createErrorFromString,
  getErrorFormatter: getErrorFormatter,
  formatStaticBuildError: formatStaticBuildError
};
